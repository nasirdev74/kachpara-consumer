...
part 'reward_share_page_state.dart';

part 'reward_share_page_cubit.freezed.dart';

@injectable
class RewardSharePageCubit extends Cubit<RewardSharePageState> {
  RewardSharePageCubit(this._storeUsecase, this._userUseCase, @factoryParam this.storeId) : super(const RewardSharePageState()) {
    getReward();
  }
