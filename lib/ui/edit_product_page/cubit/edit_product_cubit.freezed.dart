...
mixin _$EditProductState {
  EditProductStateStatus get status => throw _privateConstructorUsedError;
...
abstract class $EditProductStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({EditProductStateStatus status});
}
...
class _$EditProductStateImpl implements _EditProductState {
  const _$EditProductStateImpl({this.status = EditProductStateStatus.init});
  ...
  @override
  String toString() {
    return 'EditProductState(status: $status)';
  }
...
abstract class _EditProductState implements EditProductState {
  const factory _EditProductState({final EditProductStateStatus status}) =
      _$EditProductStateImpl;

  @override
  EditProductStateStatus get status;
  @override
  @JsonKey(ignore: true)
  _$$EditProductStateImplCopyWith<_$EditProductStateImpl> get copyWith =>
      throw _privateConstructorUsedError;
